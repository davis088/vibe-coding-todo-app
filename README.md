...
[![CI](https://github.com/victorperezpiqueras/vibe-coding-todo-app/actions/workflows/ci.yml/badge.svg)](https://github.com/victorperezpiqueras/vibe-coding-todo-app/actions/workflows/ci.yml)

<!-- [![Backend Coverage](https://img.shields.io/codecov/c/github/victorperezpiqueras/vibe-coding-todo-app?flag=backend&style=flat&logo=python&logoColor=yellow&label=backend-cov)](https://codecov.io/gh/victorperezpiqueras/vibe-coding-todo-app?flag=backend) -->
<!-- [![Frontend Coverage](https://img.shields.io/codecov/c/github/victorperezpiqueras/vibe-coding-todo-app?flag=frontend&style=flat&logo=react&logoColor=lightblue&label=frontend-cov)](https://codecov.io/gh/victorperezpiqueras/vibe-coding-todo-app?flag=frontend) -->
